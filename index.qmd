---
description-meta: |
 หนังสือนี้ โปรแกรมด้วย R โดยมีตัวอย่างที่เน้นการปฏิบัติจริง ถูกเขียนขึ้นสำหรับผู้ที่ไม่มีพื้นฐานเป็นโปรแกรมเมอร์ เพื่อให้เข้าใจภาษา R ได้อย่างเรียบง่าย คุณจะได้เรียนรู้วิธีโหลดข้อมูล ประมวลผลและแยกวัตถุข้อมูล นำทางระบบสภาพแวดล้อมของ R เขียนฟังก์ชันเอง และใช้เครื่องมือการเขียนโปรแกรมทั้งหมดใน R ตลอดทั้งหนังสือ ทักษะที่คุณเรียนรู้จะช่วยในการแก้ปัญหาทางวิทยาศาสตร์ข้อมูลในทางปฏิบัติ
---
...
หนังสือนี้ส้รางด้วย [Quarto](https://quarto.org) and published at <https://rstudio-education.github.io/hopr/>. 
:::
